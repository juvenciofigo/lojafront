<template lang="">
    ...
    <ProductDetailsComp
        ...
        <template #opcoes>
            ...
            <div
                ref="buttons"
                class="buttons-chips flex flex-col gap-3 font-semibold lg:flex-row">
                <span>
                    <el-button
                        size="small"
        ...
        <template #product-statistic>
            <div class="w-full border border-slate-50 p-1">
                <div class="my-3 flex flex-row flex-wrap justify-center gap-4">
                    <div class="flex flex-row items-center gap-2 border-[0.6px] border-slate-50 p-2 shadow-md">
                    ...
                    <div class="flex flex-row items-center border-[0.6px] border-slate-50 p-2 shadow-md">
                        <div class="flex items-center p-1">
                            <Receipt />
                        </div>
                        <div class="flex flex-col text-center">
