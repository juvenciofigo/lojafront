import _objectSpread from "D:/PROJETOS DEV/LojaJVC/lojafront/node_modules/@babel/runtime/helpers/esm/objectSpread2.js";
import _toConsumableArray from "D:/PROJETOS DEV/LojaJVC/lojafront/node_modules/@babel/runtime/helpers/esm/toConsumableArray.js";
...
function dispatch(action) {
  switch (action.type) {
    case actionTypes.ADD_TOAST:
      state.value.toasts = [action.toast]
        .concat(_toConsumableArray(state.value.toasts))
        .slice(0, TOAST_LIMIT);
      break;
    ...
    case actionTypes.UPDATE_TOAST:
      state.value.toasts = state.value.toasts.map(function (t) {
        return t.id === action.toast.id
          ? _objectSpread(_objectSpread({}, t), action.toast)
          : t;
      });
      break;
